...
# # # Get arguments from Node.js (if any)
# # args = sys.argv[1:]
...
output_file = '/Users/tk/Desktop/documents/flask-react/childp/data.json'
data = [{"Title": t, "Subtitle": s, "Link": l} for t, s, l in zip(titles, subtitles, links)]
...
if data:
    ...
    print("❌ No data extracted. Please check the XPath or website structure.")
